...
var $author$project$PhotoGroove$gotPhotoUrl = F2(
	function (index, photos) {
		var _v0 = A2($elm$core$Array$get, index, photos);
		if (_v0.$ === 'Just') {
			var photo = _v0.a;
			return photo.url;
		} else {
...
var $author$project$PhotoGroove$randomPhotoPicker = function (photos) {
	return A2(
		$elm$random$Random$int,
		0,
		$elm$core$Array$length(photos) - 1);
};
		...
		switch (msg.$) {
			...
			case 'ClickedSurpriseMe':
				return _Utils_Tuple2(
					...
					A2(
						$elm$random$Random$generate,
						$author$project$PhotoGroove$GotSelectedIndex,
						$author$project$PhotoGroove$randomPhotoPicker($author$project$PhotoGroove$photoArray)));
			case 'ClickedSize':
				var size = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
			...
			default:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							selectedUrl: A2($author$project$PhotoGroove$gotPhotoUrl, index, $author$project$PhotoGroove$photoArray)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$PhotoGroove$enumThumbnailSize = _List_fromArray(
...
var $author$project$PhotoGroove$sizeToString = function (s) {
	switch (s.$) {
		case 'Small':
			return 'small';
		case 'Medium':
...
var $author$project$PhotoGroove$sizeToClass = A2($elm$core$Basics$composeL, $elm$html$Html$Attributes$class, $author$project$PhotoGroove$sizeToString);
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_Nil),
					A2($elm$core$Basics$composeL, $elm$html$Html$text, $author$project$PhotoGroove$sizeToString)(size)
				]));
	});
		...
		_List_fromArray(
			[
				...
				A2(
					...
					$author$project$PhotoGroove$enumThumbnailSize)),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
